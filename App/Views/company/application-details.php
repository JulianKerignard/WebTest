...
<div class="page-title">
    ...
    <p>Candidature de <strong><?= View::escape($application, 'student_name', 'Étudiant') ?></strong> pour le stage <strong><?= View::escape($application, 'Offer_title', 'Non spécifié') ?></strong></p>
</div>
...
<div class="application-detail-container">
    <div class="application-header">
        ...
        <div class="application-title">
            <h2><?= View::escape($application, 'student_name', 'Étudiant') ?></h2>
            <p class="student-info"><?= View::escape($application, 'study_field', 'Non spécifié') ?> - <?= View::escape($application, 'school_name', 'Non spécifié') ?></p>
            <p class="application-meta">
                ...
                <span class="application-email"><i class="far fa-envelope"></i> <?= View::escape($application, 'student_email', 'Email non disponible') ?></span>
            </p>
        </div>
        ...
        <div class="application-column">
            <div class="application-card status-management">
                <div class="card-header-alt">
                    ...
                    <span class="status-badge <?= View::safe($application, 'status', '') ?>"><?= View::escape($application, 'status_label', 'Non défini') ?></span>
                </div>
                        ...
                        <?php foreach ($application['notes'] as $note): ?>
                            <div class="note-item">
                                <div class="note-header">
                                    <span class="note-author"><?= View::escape($note, 'author_name', 'Utilisateur') ?></span>
                                    <span class="note-date"><?= isset($note['created_at']) ? \App\Helpers\FormatHelper::timeSince($note['created_at']) : '' ?></span>
                                </div>
            ...
            <div class="application-card">
                ...
                <div class="internship-details">
                    <div class="detail-group">
                        ...
                        <p><?= View::escape($application, 'Offer_title', 'Non spécifié') ?></p>
                    </div>
                    <div class="detail-group">
                        <h4>Durée</h4>
