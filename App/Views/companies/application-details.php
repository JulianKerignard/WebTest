...
<div class="page-title">
    ...
    <p>Candidature de <strong><?= htmlspecialchars($application['student_name']) ?></strong> pour le stage <strong><?= htmlspecialchars($application['Offer_title']) ?></strong></p>
</div>
...
<div class="application-detail-container">
    <div class="application-header">
        ...
        <div class="application-title">
            <h2><?= htmlspecialchars($application['student_name']) ?></h2>
            <p class="student-info"><?= htmlspecialchars($application['study_field'] ?? 'Non spécifié') ?> - <?= htmlspecialchars($application['school_name'] ?? 'Non spécifié') ?></p>
            <p class="application-meta">
                <span class="application-date"><i class="far fa-calendar"></i> Candidature reçue le <?= date('d/m/Y', strtotime($application['created_at'])) ?></span>
                <span class="application-email"><i class="far fa-envelope"></i> <?= htmlspecialchars($application['student_email']) ?></span>
            </p>
        </div>
        ...
        <div class="application-column">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control" required>
                                <?php foreach ($status_options as $value => $label): ?>
                                    <option value="<?= $value ?>" <?= $application['status'] === $value ? 'selected' : '' ?>><?= htmlspecialchars($label) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
            ...
            <div class="application-card">
                <div class="card-header-alt">
                    ...
                    <span class="note-count"><?= count($application['notes'] ?? []) ?> notes</span>
                </div>
                        ...
                        <?php foreach ($application['notes'] as $note): ?>
                            <div class="note-item">
                                <div class="note-header">
                                    <span class="note-author"><?= htmlspecialchars($note['author_name']) ?></span>
                                    <span class="note-date"><?= htmlspecialchars(\App\Helpers\FormatHelper::timeSince($note['created_at'])) ?></span>
                                </div>
            ...
            <div class="application-card">
                ...
                <div class="internship-details">
                    <div class="detail-group">
                        ...
                        <p><?= htmlspecialchars($application['Offer_title']) ?></p>
                    </div>
                    <div class="detail-group">
                        <h4>Durée</h4>
                ...
                <div class="card-actions">
                    <a href="/company/offers/<?= $application['offer_id'] ?>" class="btn btn-outline">Voir l'offre complète</a>
                </div>
            </div>
        </div>
    </div>
